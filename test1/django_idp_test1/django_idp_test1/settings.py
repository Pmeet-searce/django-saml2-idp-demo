"""
Django settings for django_idp_test1 project.
...
SECRET_KEY = 'o7!)qc2$szk3l$gr7t0o@s@lat*ojvu%7reu+12re$5+&8_)jl'
...
ROOT_URLCONF = 'django_idp_test1.urls'
...
WSGI_APPLICATION = 'django_idp_test1.wsgi.application'
